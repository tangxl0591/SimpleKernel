...
//
// bootinit.c for Simple-XX/SimpleKernel.
...
void mm_init() {
    ...
    pgd_tmp[VMM_PGD_INDEX(KERNEL_BASE)] =
        (ptr_t)pte_kernel_tmp | VMM_PAGE_PRESENT | VMM_PAGE_RW;
<<<<<<< HEAD
    // 内核段 pgd_tmp[0x301], 4MB
    pgd_tmp[VMM_PGD_INDEX(KERNEL_BASE) + 1] =
        (ptr_t)pte_kernel_tmp2 | VMM_PAGE_PRESENT | VMM_PAGE_RW;
=======
>>>>>>> vmm_and_pmm
